...
__all__ = [
    'GetVirtualMachineByIdResult',
    'AwaitableGetVirtualMachineByIdResult',
    'get_virtual_machine_by_id',
    'get_virtual_machine_by_id_output',
]

@pulumi.output_type
class GetVirtualMachineByIdResult:
...
class AwaitableGetVirtualMachineByIdResult(GetVirtualMachineByIdResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualMachineByIdResult(
...
def get_virtual_machine_by_id(id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualMachineByIdResult:
    """
    Use this data source to access information about an existing resource.

    :param str id: Virtual Machine Id to get details of
    """
    __args__ = dict()
    __args__['id'] = id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('esxi-native:index:getVirtualMachineById', __args__, opts=opts, typ=GetVirtualMachineByIdResult).value

    return AwaitableGetVirtualMachineByIdResult(
        boot_disk_size=__ret__.boot_disk_size,
        ...
        notes=__ret__.notes,
        num_v_cpus=__ret__.num_v_cpus,
        os=__ret__.os,
        power=__ret__.power,
        resource_pool_name=__ret__.resource_pool_name,
        shutdown_timeout=__ret__.shutdown_timeout,
        startup_timeout=__ret__.startup_timeout,
        virtual_disks=__ret__.virtual_disks,
        virtual_hw_ver=__ret__.virtual_hw_ver)


@_utilities.lift_output_func(get_virtual_machine_by_id)
def get_virtual_machine_by_id_output(id: Optional[pulumi.Input[str]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetVirtualMachineByIdResult]:
    """
    Use this data source to access information about an existing resource.
